...
class LOAD_DATASET(Dataset):
    def __init__(self, root, transform=None, target_transform=None, db_idx=0, repeat_flag=False, as_train_data=False):
        ...
        # ----------------------------------
            ...
            self.data = np.repeat(imgs[datasize[2]:datasize[2]+int(datasize_3*0.5)],int(datasize_1/datasize_3),axis=0)
            ...
            self.data = np.repeat(imgs[datasize[2]+int(datasize_3*0.5):datasize[3]],int(datasize_1/datasize_3),axis=0)
